...
public class ThePillcraftadvancementProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if (itemstack.getItem() == BrokenMindWeaponsModItems.THEPILL.get()) {
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("broken_mind_weapons:the_pillcraftingachievment"));
