...
public class HambatachievmentkillpigProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		...
		if (entity instanceof Pig || entity instanceof Piglin || entity instanceof PiglinBrute || entity instanceof ZombifiedPiglin || entity instanceof Hoglin || entity instanceof Zoglin) {
			if (sourceentity instanceof Player && (sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == BrokenMindWeaponsModItems.HAMBAT.get()) {
				if (sourceentity instanceof ServerPlayer _player) {
					Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("broken_mind_weapons:ham_batkillpig"));
