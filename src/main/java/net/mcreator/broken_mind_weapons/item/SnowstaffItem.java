...
import net.mcreator.broken_mind_weapons.procedures.SnowstaffRangedItemUsedProcedure;
...
public class SnowstaffItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A79Summons 5 snow golems"));
		list.add(Component.literal("\u00A7dCooldown of 7 seconds"));
	}
}
