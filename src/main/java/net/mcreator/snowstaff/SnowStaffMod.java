 ...
 *
 */
package net.mcreator.snowstaff;
...
@Mod("snow_staff")
public class SnowStaffMod {
	public static final Logger LOGGER = LogManager.getLogger(SnowStaffMod.class);
	public static final String MODID = "snow_staff";
