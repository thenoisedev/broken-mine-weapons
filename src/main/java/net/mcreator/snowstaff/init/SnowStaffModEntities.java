...
import net.mcreator.snowstaff.entity.PeashooterEntity;
import net.mcreator.snowstaff.SnowStaffMod;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class SnowStaffModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, SnowStaffMod.MODID);
